...
```bash
# Test auth endpoint
curl -X GET "https://ticket-triage-4.preview.emergentagent.com/api/auth/me" \
  -H "Authorization: Bearer YOUR_SESSION_TOKEN"

# Test protected endpoints
curl -X GET "https://ticket-triage-4.preview.emergentagent.com/api/tickets" \
  -H "Authorization: Bearer YOUR_SESSION_TOKEN"
```
...
await page.goto("https://ticket-triage-4.preview.emergentagent.com");
```
