...
```bash
# Test auth endpoint
curl -X GET "https://customer-support-app-2.preview.emergentagent.com/api/auth/me" \
  -H "Authorization: Bearer YOUR_SESSION_TOKEN"

# Test protected endpoints
curl -X GET "https://customer-support-app-2.preview.emergentagent.com/api/tickets" \
  -H "Authorization: Bearer YOUR_SESSION_TOKEN"
```
...
await page.context.add_cookies([{
    ...
    "domain": "tickflow-6.preview.emergentagent.com",
    "path": "/",
    "httpOnly": true,
    "secure": true,
    "sameSite": "None"
}]);
await page.goto("https://customer-support-app-2.preview.emergentagent.com");
```
