...
4. Now create OAuth client:
   ...
   - **Authorized redirect URIs:**
     - `https://realtime-collab-9.preview.emergentagent.com/api/gmail/auth/callback`
5. Click **CREATE**
...
3. Enter:
   ...
   - **Delivery type:** Push
   - **Endpoint URL:** `https://realtime-collab-9.preview.emergentagent.com/api/gmail/webhook`
