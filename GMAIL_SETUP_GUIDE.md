...
4. Now create OAuth client:
   ...
   - **Authorized JavaScript origins:** 
     - `https://ticket-search-debug.preview.emergentagent.com`
   - **Authorized redirect URIs:**
     - `https://ticket-search-debug.preview.emergentagent.com/api/gmail/auth/callback`
5. Click **CREATE**
...
3. Enter:
   ...
   - **Delivery type:** Push
   - **Endpoint URL:** `https://ticket-search-debug.preview.emergentagent.com/api/gmail/webhook`
