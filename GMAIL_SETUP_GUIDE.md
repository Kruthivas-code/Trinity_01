...
4. Now create OAuth client:
   ...
   - **Authorized JavaScript origins:** 
     - `https://support-merge.preview.emergentagent.com`
   - **Authorized redirect URIs:**
     - `https://support-merge.preview.emergentagent.com/api/gmail/auth/callback`
5. Click **CREATE**
...
3. Enter:
   ...
   - **Delivery type:** Push
   - **Endpoint URL:** `https://support-merge.preview.emergentagent.com/api/gmail/webhook`
