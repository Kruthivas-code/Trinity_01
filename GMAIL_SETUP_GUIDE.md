...
4. Now create OAuth client:
   ...
   - **Authorized JavaScript origins:** 
     - `https://docs-sync-test.preview.emergentagent.com`
   - **Authorized redirect URIs:**
     - `https://docs-sync-test.preview.emergentagent.com/api/gmail/auth/callback`
5. Click **CREATE**
...
3. Enter:
   ...
   - **Delivery type:** Push
   - **Endpoint URL:** `https://docs-sync-test.preview.emergentagent.com/api/gmail/webhook`
