...
4. Now create OAuth client:
   ...
   - **Authorized JavaScript origins:** 
     - `https://tickflow-6.preview.emergentagent.com`
   - **Authorized redirect URIs:**
     - `https://tickflow-6.preview.emergentagent.com/api/gmail/auth/callback`
5. Click **CREATE**
...
3. Enter:
   ...
   - **Delivery type:** Push
   - **Endpoint URL:** `https://tickflow-6.preview.emergentagent.com/api/gmail/webhook`
