...
4. Now create OAuth client:
   ...
   - **Authorized JavaScript origins:** 
     - `https://kb-wysiwyg-upgrade.preview.emergentagent.com`
   - **Authorized redirect URIs:**
     - `https://kb-wysiwyg-upgrade.preview.emergentagent.com/api/gmail/auth/callback`
5. Click **CREATE**
...
3. Enter:
   ...
   - **Delivery type:** Push
   - **Endpoint URL:** `https://kb-wysiwyg-upgrade.preview.emergentagent.com/api/gmail/webhook`
