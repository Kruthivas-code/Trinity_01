...
4. Now create OAuth client:
   ...
   - **Authorized redirect URIs:**
     - `https://github-clone-tool-6.preview.emergentagent.com/api/gmail/auth/callback`
5. Click **CREATE**
...
3. Enter:
   ...
   - **Delivery type:** Push
   - **Endpoint URL:** `https://github-clone-tool-6.preview.emergentagent.com/api/gmail/webhook`
