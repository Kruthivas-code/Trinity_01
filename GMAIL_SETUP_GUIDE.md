...
4. Now create OAuth client:
   ...
   - **Authorized JavaScript origins:** 
     - `https://trinity-docs-refresh.preview.emergentagent.com`
   - **Authorized redirect URIs:**
     - `https://trinity-docs-refresh.preview.emergentagent.com/api/gmail/auth/callback`
5. Click **CREATE**
...
3. Enter:
   ...
   - **Delivery type:** Push
   - **Endpoint URL:** `https://trinity-docs-refresh.preview.emergentagent.com/api/gmail/webhook`
