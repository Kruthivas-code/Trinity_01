...
4. Now create OAuth client:
   ...
   - **Authorized JavaScript origins:** 
     - `https://atlas-first-sync.preview.emergentagent.com`
   - **Authorized redirect URIs:**
     - `https://atlas-first-sync.preview.emergentagent.com/api/gmail/auth/callback`
5. Click **CREATE**
...
3. Enter:
   ...
   - **Delivery type:** Push
   - **Endpoint URL:** `https://atlas-first-sync.preview.emergentagent.com/api/gmail/webhook`
