...
4. Now create OAuth client:
   ...
   - **Authorized redirect URIs:**
     - `https://knowledge-base-179.preview.emergentagent.com/api/gmail/auth/callback`
5. Click **CREATE**
...
3. Enter:
   ...
   - **Delivery type:** Push
   - **Endpoint URL:** `https://knowledge-base-179.preview.emergentagent.com/api/gmail/webhook`
