...
4. Now create OAuth client:
   ...
   - **Authorized JavaScript origins:** 
     - `https://kb-management-hub.preview.emergentagent.com`
   - **Authorized redirect URIs:**
     - `https://kb-management-hub.preview.emergentagent.com/api/gmail/auth/callback`
5. Click **CREATE**
...
3. Enter:
   ...
   - **Delivery type:** Push
   - **Endpoint URL:** `https://kb-management-hub.preview.emergentagent.com/api/gmail/webhook`
