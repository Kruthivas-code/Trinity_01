...
4. Now create OAuth client:
   ...
   - **Authorized redirect URIs:**
     - `https://trinity-atlas-import.preview.emergentagent.com/api/gmail/auth/callback`
5. Click **CREATE**
...
3. Enter:
   ...
   - **Delivery type:** Push
   - **Endpoint URL:** `https://trinity-atlas-import.preview.emergentagent.com/api/gmail/webhook`
