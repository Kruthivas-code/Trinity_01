...
4. Now create OAuth client:
   ...
   - **Authorized JavaScript origins:** 
     - `https://ticket-threads.preview.emergentagent.com`
   - **Authorized redirect URIs:**
     - `https://ticket-threads.preview.emergentagent.com/api/gmail/auth/callback`
5. Click **CREATE**
...
3. Enter:
   ...
   - **Delivery type:** Push
   - **Endpoint URL:** `https://ticket-threads.preview.emergentagent.com/api/gmail/webhook`
