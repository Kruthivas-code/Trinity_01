...
4. Now create OAuth client:
   ...
   - **Authorized redirect URIs:**
     - `https://favorite-tickets.preview.emergentagent.com/api/gmail/auth/callback`
5. Click **CREATE**
...
3. Enter:
   ...
   - **Delivery type:** Push
   - **Endpoint URL:** `https://favorite-tickets.preview.emergentagent.com/api/gmail/webhook`
