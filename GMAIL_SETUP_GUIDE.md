...
4. Now create OAuth client:
   ...
   - **Authorized redirect URIs:**
     - `https://trinity-events-1.preview.emergentagent.com/api/gmail/auth/callback`
5. Click **CREATE**
...
3. Enter:
   ...
   - **Delivery type:** Push
   - **Endpoint URL:** `https://trinity-events-1.preview.emergentagent.com/api/gmail/webhook`
