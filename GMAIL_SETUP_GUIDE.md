...
4. Now create OAuth client:
   ...
   - **Authorized JavaScript origins:** 
     - `https://assign-me-fix.preview.emergentagent.com`
   - **Authorized redirect URIs:**
     - `https://assign-me-fix.preview.emergentagent.com/api/gmail/auth/callback`
5. Click **CREATE**
...
3. Enter:
   ...
   - **Delivery type:** Push
   - **Endpoint URL:** `https://assign-me-fix.preview.emergentagent.com/api/gmail/webhook`
