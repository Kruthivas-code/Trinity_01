from fastapi import FastAPI, HTTPException, Depends, status as http_status, File, UploadFile, Response, Request, Cookie, Header, Security, BackgroundTasks
...
if not ALLOWED_ORIGINS or ALLOWED_ORIGINS == [""]:
    ALLOWED_ORIGINS = [
        "https://many2many.preview.emergentagent.com",
        "http://localhost:3000",
        "http://127.0.0.1:3000"
    ]
...
async def gmail_callback(code: str = None, state: str = None, error: str = None):
    ...
    frontend_url = "https://many2many.preview.emergentagent.com"
...
async def send_csat_survey(
    ...
    base_url = "https://many2many.preview.emergentagent.com"
