...
class TrinityAPITester:
    def __init__(self, base_url="https://knowledge-base-179.preview.emergentagent.com"):
...
def main():
    ...
    # Setup tester
    tester = TrinityAPITester("https://knowledge-base-179.preview.emergentagent.com")
