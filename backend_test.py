...
class TrinityAPITester:
    def __init__(self, base_url="https://customer-support-app-2.preview.emergentagent.com"):
...
def main():
    ...
    # Setup tester
    tester = TrinityAPITester("https://customer-support-app-2.preview.emergentagent.com")
