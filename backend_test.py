...
class TrinityAPITester:
    def __init__(self, base_url="https://docs-rebuild-polish.preview.emergentagent.com"):
...
def main():
    ...
    # Setup tester
    tester = TrinityAPITester("https://docs-rebuild-polish.preview.emergentagent.com")
