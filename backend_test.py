...
class TrinityAPITester:
    def __init__(self, base_url="https://ticket-ai-system-1.preview.emergentagent.com"):
...
def main():
    ...
    # Setup tester
    tester = TrinityAPITester("https://ticket-ai-system-1.preview.emergentagent.com")
