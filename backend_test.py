...
class TrinityAPITester:
    def __init__(self, base_url="https://trinity-atlas-import.preview.emergentagent.com"):
...
def main():
    ...
    # Setup tester
    tester = TrinityAPITester("https://trinity-atlas-import.preview.emergentagent.com")
