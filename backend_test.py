...
class TrinityAPITester:
    def __init__(self, base_url="https://kb-wysiwyg-upgrade.preview.emergentagent.com"):
...
def main():
    ...
    # Setup tester
    tester = TrinityAPITester("https://kb-wysiwyg-upgrade.preview.emergentagent.com")
