...
class TrinityAPITester:
    def __init__(self, base_url="https://trinity-docs-refresh.preview.emergentagent.com"):
...
def main():
    ...
    # Setup tester
    tester = TrinityAPITester("https://trinity-docs-refresh.preview.emergentagent.com")
