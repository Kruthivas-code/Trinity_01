...
class TrinityAPITester:
    def __init__(self, base_url="https://conversation-rebuild.preview.emergentagent.com"):
...
def main():
    ...
    # Setup tester
    tester = TrinityAPITester("https://conversation-rebuild.preview.emergentagent.com")
