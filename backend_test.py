...
class TrinityAPITester:
    def __init__(self, base_url="https://data-integrity-fix-37.preview.emergentagent.com"):
...
def main():
    ...
    # Setup tester
    tester = TrinityAPITester("https://data-integrity-fix-37.preview.emergentagent.com")
