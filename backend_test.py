...
class TrinityAPITester:
    def __init__(self, base_url="https://view-upgrade-stage.preview.emergentagent.com"):
...
def main():
    ...
    # Setup tester
    tester = TrinityAPITester("https://view-upgrade-stage.preview.emergentagent.com")
