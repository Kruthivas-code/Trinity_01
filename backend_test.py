...
class TrinityAPITester:
    def __init__(self, base_url="https://dense-email-viewer.preview.emergentagent.com"):
...
def main():
    ...
    # Setup tester
    tester = TrinityAPITester("https://dense-email-viewer.preview.emergentagent.com")
    ...
    if tester.failed_endpoints:
        ...
        for fail in tester.failed_endpoints:
            print(f"   • {fail['name']}: {fail.get('error', f'Status {fail.get(\"actual\")} vs {fail.get(\"expected\")}')} ")
