...
class TrinityAPITester:
    def __init__(self, base_url="https://ticket-search-debug.preview.emergentagent.com"):
...
def main():
    ...
    # Setup tester
    tester = TrinityAPITester("https://ticket-search-debug.preview.emergentagent.com")
